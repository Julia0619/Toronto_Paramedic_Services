...
Similarly, as vehicle accidents can be a second potential driver of EMS demand, overall EMS demand may be better managed if paramedic service strategies also target vehicle-accident-related calls. Traffic congestion has been found to increase paramedic response times [@journal], and with the current increase in traffic due to multiple construction projects throughout Toronto, longer paramedic response times and the unavailability of paramedic services can be expected. To efficiently navigate EMS demand for vehicle accidents, strategies may center around accident prevention or effective distribution of resources near accident-prone regions for faster response times. 
...
data <- st_read("~/Toronto_Paramedic_Services/data/ForwardSortationAreas/Forward_SortationAreas")

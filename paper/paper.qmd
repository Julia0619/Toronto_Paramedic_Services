...
data |>
  slice(1:6) |>
  kable(
    col.names = c("Year", "Medical Emergency Calls", "Vehicle Accident Calls", "Emergency Transfer Calls",
...
To map this data, a shapefile with the boundaries for Toronto's FSAs was required. This data was acquired from the Open Government Data portal by the Government of Canada (CITATION). 
...
summary_data <- summary(data[1,2:8])
view(summary_data)

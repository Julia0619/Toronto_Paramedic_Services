...
data |>
  ...
  theme_light() +
  labs(
    x = "Year", color = "Incident Type",
    caption = "Data Source: Toronto Paramedic Services"
  ) +
  scale_color_brewer(palette = "Set3", labels = c("Airport Standbys", "Emergency Transfers", "Fires", "Medical Emergencies", "Total Emergency Calls", "Vehicle Accidents")) +
...
data |>
  ...
  scale_color_brewer(palette = "Set3", labels = c("Airport Standbys", "Emergency Transfers", "Fires", "Vehicle Accidents")) +
  ggtitle("EMS Demand (2017-2022) Based on Incident Type") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
# Reading in the data to show in map
library(readr)
analysis_data_FOR_MAP <- read_csv("data/analysis_data/analysis_data_FOR_MAP.csv")
View(analysis_data_FOR_MAP)
